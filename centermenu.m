...
winTopGap   = round(screensize(4)/3);       % gap between top of screen and top of figure **
winLeftGap  = round(screensize(3)/2.5);       % gap between side of screen and side of figure **
